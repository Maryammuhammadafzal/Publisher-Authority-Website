...
const CallTOAction = () => {
    return (
        <div className='w-full h-auto flex justify-center items-center py-6 px-10'>
            <div className='w-full flex justify-center min-h-[150px] items-center py-10 px-10 relative'>
                ...
                <div className='absolute top-0 left-0 w-full h-full flex justify-between items-center z-10 px-20 py-6 mix-blend-normal'>
                    ...
                    <Button className='hover:bg-secondary/80 text-xl font-semibold hover:border hover:border-secondary/80 hover:text-primary px-10 py-8 bg-secondary text-primary '>Get Started</Button>
